...
fun HomeScreen(
    ...
    val commonModifier: Modifier = modifier.padding(contentPadding)
    when (marsUiState) {
        is MarsUiState.Loading -> {
            LoadingScreen(modifier = commonModifier.fillMaxSize())
        }
        ...
        is MarsUiState.Error -> {
            ErrorScreen(modifier = commonModifier.fillMaxSize())
        }
    }
}
